 ...
 */
public class DuasFacil extends javax.swing.JInternalFrame {
    ...
    public DuasFacil() {
        ...
        letrinhas2 = new JTextField[4];
        letrinhas2[0] = jTextField5;
        letrinhas2[1] = jTextField6;
        letrinhas2[2] = jTextField7;
        letrinhas2[3] = jTextField8;
        ...
        //estabelesce q tem palavra2, tem 6 tentativas, o retorno tem 4 de tamanho e o retorno2 tem 4 de tamanho tbm
        jogo = new Jogo("", 6, 4, 4);
        jogo.sorteiaPalavra("palavras4letras.txt", 1); //sorteia palavra 1
        jogo.sorteiaPalavra("palavras4letras.txt", 2); //sorteia palavra 2
    }
    ...
    public void novoJogo() {
        ...
        jogo.sorteiaPalavra("palavras4letras.txt", 2);
        reiniciaTentativas();
    }
