 ...
 */
public class DuasMedio extends javax.swing.JInternalFrame {

    public DuasMedio() {
        initComponents();

        letrinhas = new JTextField[5];
        ...
        letrinhas2 = new JTextField[5];
        letrinhas2[0] = jTextField6;
        letrinhas2[1] = jTextField7;
        letrinhas2[2] = jTextField8;
        letrinhas2[3] = jTextField9;
        letrinhas2[4] = jTextField10;
        ...
        //estabelesce q tem palavra2, tem 9 tentativas, o retorno tem 5 de tamanho e o retorno2 tem 5 de tamanho tbm
        jogo = new Jogo("", 9, 5, 5);
        jogo.sorteiaPalavra("palavras5letras.txt", 1); //sorteia palavra 1
        jogo.sorteiaPalavra("palavras5letras.txt", 2); //sorteia palavra 2
    }
    ...
    public void novoJogo() {
        ...
        habilitaBotoes(true);
        jogo = new Jogo("", 9, 5, 5);
        jogo.sorteiaPalavra("palavras5letras.txt", 1);
        jogo.sorteiaPalavra("palavras5letras.txt", 2);
        reiniciaTentativas();
    }
    ...
    private void initComponents() {
        ...
        Titulo.setText("JOGO DA FORCA - MODO MÉDIO");
        ...
        jPanel4.setBackground(new java.awt.Color(234, 225, 246));
